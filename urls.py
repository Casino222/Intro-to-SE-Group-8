...
urlpatterns = [
    ...
    path('compare/', views.Compare, name='compare-products'),
...
admin.site.site_header = "Games Hub"
admin.site.site_title = "Games Hub"
admin.site.site_index_title = "Welcome to Games Hub"